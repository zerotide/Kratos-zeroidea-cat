                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3 footer-list text-center">
                                    ...
                                    <p> © <?php echo date('Y'); ?> <a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?></a>. All Rights Reserved. | 本站已运行<span id=span_dt_dt>Loading...
                                    <?php if(kratos_option('icp_num')) echo '<br><a href="https://www.livetide.cn/" rel="external nofollow" target="_blank">'.kratos_option('icp_num').'</a>';
